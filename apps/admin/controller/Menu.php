...
class Menu extends Admin {
    ...
    public function index(){
        ...
        //移动上级按钮属性
        $move_position_attr['icon'] = 'fa fa-exchange"';
        $move_position_attr['title'] = '移动位置';
        $move_position_attr['class'] = 'btn btn-info btn-sm';
        $move_position_attr['onclick'] = 'move_menuparent()';
