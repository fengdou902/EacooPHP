...
CREATE TABLE IF NOT EXISTS `eacoo_posts` (
  ...
  KEY `type` (`type`),
  KEY `status` (`status`),
  KEY `top_post` (`istop`,`status`),
  KEY `recommend` (`recommended`,`status`)
...
(5, '贝恩：企业大数据战略指南', '', 'post', NULL, '这是摘要dgs', '<p>fs</p><p>fsdf</p><p><br></p><img class="" src="http://localhost/ZhaoCMF/Uploads/Picture/2016-09-26/57e8ddc3e1455.jpeg" data-id="363">fsafsaf', 1, '关键字1', 88, 0, 0, 0, 0, NULL, NULL, 0, 0, 0, 1464791552, 1506666212, 0, 1),
